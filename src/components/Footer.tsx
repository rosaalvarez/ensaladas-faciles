    ...
    <footer className="bg-gray-900 text-white">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="flex gap-4">
              {[
                { name: 'TikTok', href: 'https://www.tiktok.com/@natalialunao', icon: (
                ...
                { name: 'Instagram', href: 'https://www.instagram.com/natalialunao', icon: (
                ...
                { name: 'Facebook', href: 'https://www.facebook.com/profile.php?id=61575047498498', icon: (
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                )},
                { name: 'Pinterest', href: 'https://www.pinterest.com/astravalkyria', icon: (
                ...
                <a key={s.name} href={s.href} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition" aria-label={s.name}>
                  {s.icon}
                </a>
              ))}
            </div>
      ...
      <div className="border-t border-gray-800">
        <div className="max-w-6xl mx-auto px-4 py-5 text-center text-sm text-gray-500">
          ...
          <p className="mt-1">© 2026 VersaLab. Nutre es un producto de VersaLab. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  );
